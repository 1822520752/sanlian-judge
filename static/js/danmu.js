...
(function () {
  ...
  // 30+ 条预设弹幕,真实 B 站梗向口吻
  var POOL = [
    { name: "影视飓风Tim", initial: "影", text: "三连指数 98,实至名归,我先投币为敬 🪙🪙🪙", region: "上海" },
    { name: "何同学工作室", initial: "何", text: "鉴定结果:这 UP 主脑洞浓度爆表,建议反复观看 3 遍", region: "北京" },
    { name: "罗翔说刑法", initial: "罗", text: "三连指数 99,但作为一个刑法老师,我不建议大家模仿", region: "北京" },
    { name: "老番茄", initial: "老", text: "鉴定结果:这是一个正常人 —— 鉴定委员会你在说什么?!", region: "上海" },
    { name: "中国boy超级大猩猩", initial: "中", text: "离谱指数拉满,建议直接封号(hhhhh)", region: "广东" },
    { name: "敖厂长", initial: "敖", text: "鉴定委员会给的标签也太准了,我笑着笑着就哭了", region: "四川" },
    { name: "盗月社食遇记", initial: "盗", text: "弹幕人格那块笑死,下次一定三连 👍", region: "北京" },
    { name: "百大 UP 主", initial: "百", text: "鉴定太准,求官方出个心理测试 PDF", region: "北京" },
    { name: "哔哩哔哩漫画", initial: "哔", text: "啊这,这是被官方盖章的离谱现场", region: "上海" },
    { name: "央视网快看", initial: "央", text: "鉴定很权威,看完只想一键三连", region: "北京" },
    { name: "影视飓风", initial: "影", text: "救命,这个精神状态图谱我以为是我自己", region: "上海" },
    { name: "极客湾", initial: "极", text: "作为数码区 UP,鉴定结果居然是键盘侠本侠 😂", region: "广东" },
    { name: "野生技术协会", initial: "野", text: "离谱指数 87,这 UP 主和我精神状态一模一样", region: "浙江" },
    { name: "哔哩哔哩课堂", initial: "课", text: "鉴定委员会表示:你的前世今生已被我们成功破译", region: "上海" },
